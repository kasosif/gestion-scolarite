        ...
        <div class="row">
            ...
            @else
                <div class="alert alert-warning z-depth-1">
                    <strong>Oops!</strong> Aucun Seance Trouvé.
                </div>
            @endif
        </div>
        <!-- ./cotainer -->
...
@section('scriptpage')
    ...
    <script>
        ...
        function deleteRessource(id,nom) {
            $('#deleteform').attr('action','{{route('seance.destroy')}}'+'/'+id);
            $('.modal-body').html('<h2>Etes-vous sûr de vouloir supprimer la seance:'+nom+'</h2>');
